...
#     result = app.invoke(
#         {"topic": topic, "agent_outcome": None, "intermediate_steps": [], "assets": []},
#         config={"recursion_limit": 30},
#     )

#     # diagnostics (remove later)
#     print("TOOL CALLS:", [(a.tool, a.tool_input) for a, _ in result.get("intermediate_steps", [])])
...
#     print("DOC_SPEC section images:",
#           [(s.get("heading"), len(s.get("images", []))) for s in doc_spec.get("sections", [])])

#     assets_by_id = {a["asset_id"]: a for a in result.get("assets", [])}

#     out_path = os.path.join("output", "blog.docx")
#     render_docx(doc_spec, assets_by_id, out_path)

#     media = _list_embedded_media(out_path)
#     print("Saved:", out_path)
#     print("Embedded images:", media)
#     return out_path
